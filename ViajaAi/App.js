...
export default function App() {
  ...
  async function handleGenerate() {
    ...
    const prompt = 'Crie um roteiro para uma viagem de exatos ${days.toFixed(0)} dias na cidade de ${city}, busque por lugares mais visitados, seja preciso nos dias de estadia fornecidos e limite o roteiro apenas na cidade fornecida. Forneça apenas em tópicos com nome do local onde ir em cada dia.'
   
    fetch('https://api.openai.com/v1/chat/completions&#39', {
      method: 'POST',
      headers: {
